function outRV = importIQUVdat(filename, dataLines)
%IMPORTFILE Import data from a text file
%  OUTRV = IMPORTFILE(FILENAME) reads data from text file FILENAME for
%  the default selection.  Returns the numeric data.
%
%  OUTRV = IMPORTFILE(FILE, DATALINES) reads data for the specified row
%  interval(s) of text file FILENAME. Specify DATALINES as a positive
%  scalar integer or a N-by-2 array of positive scalar integers for
%  dis-contiguous row intervals.
%
%  Example:
%  outRV = importfile("/Users/leanneiannucci/Desktop/iquv-0.8.3/outRV.dat", [1, Inf]);
%
%  See also READTABLE.
%
% Auto-generated by MATLAB on 07-Sep-2022 14:44:51
...
% Import the data
outRV = readtable(filename, opts);

%% Convert to output type
outRV = table2array(outRV);
end